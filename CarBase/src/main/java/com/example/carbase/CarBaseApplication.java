...
import com.example.carbase.domain.User;
import com.example.carbase.domain.UserRepository;
import com.example.carbase.domain.Owner;
import com.example.carbase.domain.OwnerRepository;

@SpringBootApplication
public class CarBaseApplication implements CommandLineRunner {
    private static final Logger logger =
            LoggerFactory.getLogger(CarBaseApplication.class);
    ...
    public void run(String... args) throws Exception {
        ...
        urepository.save(new User("Viktor", "KamiSama", "ADMIN"));
    }
}
